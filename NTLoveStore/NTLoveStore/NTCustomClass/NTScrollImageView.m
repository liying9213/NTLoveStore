...
@implementation NTScrollImageView
...
{
    NTScrollImageView * scrollImageView = [[NTScrollImageView alloc]initWithFrame:frame];
    [scrollImageView setimageLinkURL:imageLinkURL];
    [scrollImageView setPageControlShowStyle:PageControlShowStyle];
